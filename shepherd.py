...
_aparser.add_argument('--skip', type=str, nargs='+', default='The job information list you are going to skip')
...
_aparser.add_argument('-s', '--sys', type=str, nargs='+', default='', help='Set system config')
_aparser.add_argument('-u', '--usr', type=str, nargs='+', default='', help='Set user config')
