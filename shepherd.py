...
_aparser.add_argument('--prfx', type=str, default='', help='The default prefix of the job')
_aparser.add_argument('--workspace', type=str, default='', help='The directory of the workspace')
_aparser.add_argument('--data', type=str, default='', help='The directory of the data')
_aparser.add_argument('--out', type=str, default='', help='The directory of the output')
_aparser.add_argument('--log', type=str, default='', help='The log file')
_aparser.add_argument('--skip', type=str, nargs='+', default='', help='The job information list you are going to skip')
_aparser.add_argument('--local', action='store_true', help='Run the code in login node when on server')
_aparser.add_argument('--overwrite', action='store_true', help='Rerun the jobs you have already ran')
_aparser.add_argument('-s', '--sys', type=str, nargs='+', default='', help='Set system config, which can by visited by the attributes of SYS')
_aparser.add_argument('-u', '--usr', type=str, nargs='+', default='', help='Set user config, which can by visited by the attributes of USR')
_aparser.add_argument('-d', '--dry', action='store_true', help='Dry run')
_aparser.add_argument('-e', '--est', action='store_true', help='Estimate the number of jobs')
_aparser.add_argument('-l', '--latest', action='store_true', help='Run the code in for workspace')
...
def init():
    ...
    if SYS.host == 'local' or _args.local:
        ...
        init_cluster()
    SYS.python_dir = '%(workspace)s/src/python' % SYS if _args.latest else '%(src)s/python' % SYS
